...
from ..lib.middleware import get_current_user, get_current_automation, AuthenticatedUser, AuthenticatedAutomation
...
async def exchange_token(request: TokenRequest) -> TokenResponse:
    ...
    try:
        ...
        permissions = github_client.get_user_permissions(result.user_role)
...
async def create_automation_token(
    request: AutomationTokenRequest,
    ...
    try:
        ...
        return TokenResponse(
            ...
            token_type="Bearer",
            expires_in=result["expires_in_days"] * 24 * 3600,  # Convert days to seconds
