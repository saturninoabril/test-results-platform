...
class PerformantDatabaseManager:
        ...
        try:
            async with self.get_session() as session:
                ...
                return {
                    ...
                    "connection_pool": self.get_connection_pool_stats().dict(),
    ...
    def get_query_performance_stats(self) -> Dict[str, Dict]:
    ...
    async def prepare_for_load(self):
...
perf_db_manager: Optional[PerformantDatabaseManager] = None
...
async def init_performant_database(
    ...
    **kwargs
    ...
    perf_db_manager = PerformantDatabaseManager(database_url, **production_config)
...
async def get_perf_db_session() -> AsyncGenerator[AsyncSession, None]:
